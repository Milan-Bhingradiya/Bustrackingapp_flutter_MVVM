...
class Driver_chatting_screen extends StatefulWidget {
  const Driver_chatting_screen({super.key});

  @override
  State<Driver_chatting_screen> createState() => _Driver_chatting_screenState();
}

class _Driver_chatting_screenState extends State<Driver_chatting_screen> {
  TextEditingController chat_textfield_controller = TextEditingController();
  dynamic driver_chattingscreen_viewmodel = null;
  ...
  void initState() {
    ...
    driver_chattingscreen_viewmodel =
        Provider.of<Driver_chattingscreen_viewmodel>(context, listen: false);
  ...
  Widget build(BuildContext context) {
    return (driver_chattingscreen_viewmodel == null)
              ...
              title: Row(
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      Text(
                        driver_chattingscreen_viewmodel.parentname,
                        style: TextStyle(
                          color: Colors.blue,
                        ),
                      ),
                ...
                Expanded(
                    ...
                    child: StreamBuilder(
                      stream: FirebaseFirestore.instance
                          ...
                          .doc(driver_loginscreen_viewmodel.institute_doc_u_id
                              .toString())
                          .collection("drivers")
                          .doc(driver_loginscreen_viewmodel.driver_doc_u_id
                              .toString())
                          .collection("chat")
                          .snapshots(),
                      builder: (context, snapshot) {
                        if (snapshot.hasData) {
                          ...
                          final chat_document = snapshot.data!.docs.where(
                              (element) =>
                                  element.id ==
                                  "with_p_${driver_chattingscreen_viewmodel.parent_doc_u_id}");
                          ...
                          try {
                            if (chat_document.isEmpty) {
                              print(
                                  "chat_document is empty in driver chatting screen");
                            }
                          ...
                          for (var i = 0; i < sort_allmsg.length; i++) {
                            final msg_bubble = msgbubble(
                              ...
                              ("${sort_allmsg[i]["send_or_recive"]}" == "send")
                                  ? true
                                  : false,
                            );
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        InkWell(
                          onTap: () async {
                            driver_chattingscreen_viewmodel.upload_msg_to_db(
                                context, chat_textfield_controller);
                            chat_textfield_controller.clear();
...
class msgbubble extends StatelessWidget {
  ...
  bool isme;
  msgbubble(this.msgtext, this.isme);
